 ...
 *
 * AJAX endpoint: search customers (patients) for Select2 autocomplete.
 *
 * Used by the sales order create form to avoid loading all patients
...
// -------------------------------------------------------------------------
// Mode: search customers/patients by term (for Select2 AJAX)
...
if ($action === 'search') {
	...
	$sql .= " AND s.client IN (1, 2, 3) AND s.status = 1";
